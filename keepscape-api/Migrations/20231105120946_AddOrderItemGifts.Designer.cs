...
namespace keepscape_api.Migrations
{
    ...
    [Migration("20231105120946_AddOrderItemGifts")]
    partial class AddOrderItemGifts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("keepscape_api.Models.OrderItemGift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderItemGifts");
                });

            modelBuilder.Entity("keepscape_api.Models.OrderPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PaymentMethodOrderId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("keepscape_api.Models.Place", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("keepscape_api.Models.OrderItemGift", b =>
                {
                    b.HasOne("keepscape_api.Models.OrderItem", null)
                        .WithOne("Gift")
                        .HasForeignKey("keepscape_api.Models.OrderItemGift", "OrderItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("keepscape_api.Models.OrderItem", "OrderItem")
                        .WithMany()
                        .HasForeignKey("OrderItemId1");

                    b.HasOne("keepscape_api.Models.Place", "Place")
                        .WithMany()
